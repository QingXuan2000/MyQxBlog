 ...
 */
type FeatherdownHeadingOptions = {
    slugs?: boolean;
    anchors?: boolean;
    toc?: boolean;
};
 ...
 */
type FeatherdownPublishingOptions = {
    excerpt?: boolean;
    wordCount?: boolean;
    readingTime?: boolean;
};
 ...
 * user-intent toggles.
 */
type FeatherdownOptions = RenderMarkdownOptions & {
    /**
 ...
 */
type FeatherdownParseOptions = FeatherdownOptions;
/**
 ...
 */
type FeatherdownResult = RenderMarkdownDocumentResult & {
    excerpt: string | null;
    /**
...
export type { FeatherdownResult as F, HeadingMetadata as H, RenderDiagnostic as R, TocItem as T, FeatherdownOptions as a, RenderMarkdownOptions as b, FeatherdownParseOptions as c, RenderMarkdownDocumentResult as d, FeatherdownCodeOptions as e, FeatherdownHeadingOptions as f, FeatherdownMathOptions as g, FeatherdownMetadata as h, FeatherdownPublishingOptions as i };
